...
import 'package:trail2/src/features/authentication/screens_client/dashboard_client/widgets/Displayinflu.dart';
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Welcome to the world of Talents!",
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        showSearch(
                            context: context, delegate: SearchScreenClient());
                      },
                    ),
                    SizedBox(
                        child: OutlinedButton(
                            onPressed: () => Get.to(() => UserdetailsClient()),
              ...
              DashBoardCategoriesClient(txttheme: txttheme),
              Display_influClient(controlljob: controlljob)
            ],
          ),
        ),
      ),
