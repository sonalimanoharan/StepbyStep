...
class UserDetailDisplayScreen extends StatefulWidget {
  const UserDetailDisplayScreen({super.key, this.data});
  final QueryDocumentSnapshot<Object?>? data;
  @override
  State<UserDetailDisplayScreen> createState() =>
      _UserDetailDisplayScreenState();
}

class _UserDetailDisplayScreenState extends State<UserDetailDisplayScreen> {
  @override
